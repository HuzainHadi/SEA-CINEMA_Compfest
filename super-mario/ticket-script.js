...
function updatePaymentAmount() {
  ...
  const paymentAmount = selectedSeats.length * 49000;
...
function showPaymentSection() {
  ...
  paymentAmountElement.textContent = "Rp" + selectedSeats.length * 49000;
  payButton.disabled = balance < selectedSeats.length * 49000;
}

// Function to process payment
function processPayment() {
  if (balance < selectedSeats.length * 49000) {

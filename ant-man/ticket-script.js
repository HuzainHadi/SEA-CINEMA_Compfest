...
function updatePaymentAmount() {
  ...
  const paymentAmount = selectedSeats.length * 51000;
...
function showPaymentSection() {
  ...
  paymentAmountElement.textContent = "Rp" + selectedSeats.length * 51000;
  payButton.disabled = balance < selectedSeats.length * 51000;
}

// Function to process payment
function processPayment() {
  if (balance < selectedSeats.length * 51000) {

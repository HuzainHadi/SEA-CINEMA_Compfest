...
function updatePaymentAmount() {
  ...
  const paymentAmount = selectedSeats.length * 60000;
...
function showPaymentSection() {
  ...
  paymentAmountElement.textContent = "Rp" + selectedSeats.length * 60000;
  payButton.disabled = balance < selectedSeats.length * 60000;
}

// Function to process payment
function processPayment() {
  if (balance < selectedSeats.length * 60000) {

...
function updatePaymentAmount() {
  ...
  const paymentAmount = selectedSeats.length * 53000;
...
function showPaymentSection() {
  ...
  paymentAmountElement.textContent = "Rp" + selectedSeats.length * 53000;
  payButton.disabled = balance < selectedSeats.length * 53000;
}

// Function to process payment
function processPayment() {
  if (balance < selectedSeats.length * 53000) {

...
function updatePaymentAmount() {
  ...
  const paymentAmount = selectedSeats.length * 10000;
...
function showPaymentSection() {
  ...
  paymentAmountElement.textContent = "Rp" + selectedSeats.length * 10000;
  payButton.disabled = balance < selectedSeats.length * 10000;
}

// Function to process payment
function processPayment() {
  if (balance < selectedSeats.length * 10000) {
